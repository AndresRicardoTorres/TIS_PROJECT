...
param_14 = ViewTypeParameter.create! :name => 'master_detail', :description => 'Maestro - Detalle',      :value => '1.1',  :level => 'low',       :label => 'Baja (1.1)',     :section => 'Tipo de Pantalla'
param_15 = ViewTypeParameter.create! :name => 'master_detail', :description => 'Maestro - Detalle',      :value => '1.3',  :level => 'mid',       :label => 'Media (1.3)',    :section => 'Tipo de Pantalla'
param_16 = ViewTypeParameter.create! :name => 'master_detail', :description => 'Maestro - Detalle',      :value => '1.5',  :level => 'high',      :label => 'Alta (1.5)',     :section => 'Tipo de Pantalla'

param_17 = ViewTypeParameter.create! :name => 'process',       :description => 'Proceso',                :value => '1.08', :level => 'low',       :label => 'Baja (1.08)',     :section => 'Tipo de Pantalla'
param_18 = ViewTypeParameter.create! :name => 'process',       :description => 'Proceso',                :value => '1.2',  :level => 'mid',       :label => 'Media (1.2)',    :section => 'Tipo de Pantalla'
param_19 = ViewTypeParameter.create! :name => 'process',       :description => 'Proceso',                :value => '1.5',  :level => 'high',      :label => 'Alta (1.5)',     :section => 'Tipo de Pantalla'

param_20 = ViewTypeParameter.create! :name => 'graphics_interactive', :description => 'Interactiva grafica (activeX, applet)', :value => '1.3',  :level => 'low',       :label => 'Baja (1.3)',     :section => 'Tipo de Pantalla'
param_21 = ViewTypeParameter.create! :name => 'graphics_interactive', :description => 'Interactiva grafica (activeX, applet)', :value => '1.5',  :level => 'mid',       :label => 'Media (1.5)',    :section => 'Tipo de Pantalla'
param_22 = ViewTypeParameter.create! :name => 'graphics_interactive', :description => 'Interactiva grafica (activeX, applet)', :value => '1.8',  :level => 'high',      :label => 'Alta (1.8)',     :section => 'Tipo de Pantalla'

param_23 = ViewTypeParameter.create! :name => 'basic_report', :description => 'Reporte basico' ,      :value => '1.03',  :level => 'low',       :label => 'Baja (1.03)',     :section => 'Tipo de Pantalla'
param_24 = ViewTypeParameter.create! :name => 'basic_report', :description => 'Reporte basico' ,      :value => '1.1',  :level => 'mid',       :label => 'Media (1.1)',    :section => 'Tipo de Pantalla'
param_25 = ViewTypeParameter.create! :name => 'basic_report', :description => 'Reporte basico' ,      :value => '1.3',  :level => 'high',      :label => 'Alta (1.3)',     :section => 'Tipo de Pantalla'

param_26 = ViewTypeParameter.create! :name => 'graphic_report', :description => 'Reporte grafico',      :value => '1.3',  :level => 'low',       :label => 'Baja (1.3)',     :section => 'Tipo de Pantalla'
param_27 = ViewTypeParameter.create! :name => 'graphic_report', :description => 'Reporte grafico',      :value => '1.5',  :level => 'mid',       :label => 'Media (1.5)',    :section => 'Tipo de Pantalla'
param_28 = ViewTypeParameter.create! :name => 'graphic_report', :description => 'Reporte grafico',      :value => '1.8',  :level => 'high',      :label => 'Alta (1.8)',     :section => 'Tipo de Pantalla'

param_29 = ViewTypeParameter.create! :name => 'mixed_report', :description => 'Reporte mixto' ,      :value => '1.4',  :level => 'low',       :label => 'Baja (1.4)',     :section => 'Tipo de Pantalla'
param_30 = ViewTypeParameter.create! :name => 'mixed_report', :description => 'Reporte mixto' ,      :value => '1.6',  :level => 'mid',       :label => 'Media (1.6)',    :section => 'Tipo de Pantalla'
param_31 = ViewTypeParameter.create! :name => 'mixed_report', :description => 'Reporte mixto' ,      :value => '2.0',  :level => 'high',      :label => 'Alta (2.0)',     :section => 'Tipo de Pantalla'
